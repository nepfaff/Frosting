...
class GaussianRasterizer(nn.Module):
    def __init__(self, raster_settings):
        ...
        self.fx = fov2focal(2.0 * math.atan(self.tanfovx), self.image_width)
        self.fy = fov2focal(2.0 * math.atan(self.tanfovy), self.image_height)

        self.K = get_intrinsics_for_gsplat(
            self.fx, self.fy, self.image_width, self.image_height
